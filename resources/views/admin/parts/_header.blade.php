...
<div class="header-advance-area" style="margin-top: 5%">
                            ...
                            <div class="col-lg-1 col-md-0 col-sm-1 col-xs-12">
                                <div class="menu-switcher-pro">
                                    {{-- <button type="button" id="sidebarCollapse" class="btn bar-button-pro header-drl-controller-btn btn-info navbar-btn">
                                        ...
                                        <img  class="main-logo" src="{{ asset('assets/img/logo/logo.jpeg') }}" >
                                </div>
                            </div>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            {{--  <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                ...
                                                <li><a href="{{ route('logout') }}"
                                                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><span class="fa fa-lock author-log-ic"></span>Salir</a>
                                                </li>
